...
if __name__ == '__main__':
    ...
    txid_to_spend = (
        '35fa4f606ecc5ae8d833bede24c86b34eaa0cc02306bd98be960afedcba5390c')
    ...
    El Output da un error (missing dummy), cuando he intentado que solamente se pueda autorizar la transaccion con 
    una public key de una persona y la del banco(myprivatekey).
